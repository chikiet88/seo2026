...
```mermaid
gantt
    title Kế Hoạch Tổng Lực SEO & Tech 2026
    dateFormat YYYY-MM-DD
    axisFormat %m/%Y

    section SEO Manager (Strategy & Content)
    Audit & Research 2 Brand          :2026-01-01, 31d
    Xây dựng Entity & Schema Map      :2026-02-01, 28d
    Chiến dịch Tuyển sinh Timona Q2   :2026-03-01, 120d
    SEO Case Study Taza Q3            :2026-07-01, 92d
    Tối ưu hóa AI Citation            :active, 2026-01-01, 365d

    section Tech (Next.js Migration & Dev)
    Thiết kế System Architecture      :2026-01-01, 60d
    Phát triển Core Next.js (Timona)  :2026-03-01, 90d
    Data Migration & SEO Redirects    :2026-06-01, 60d
    Phát triển Core Next.js (Taza)    :2026-08-01, 90d
    Go-live & Tối ưu Performance      :2026-11-01, 61d

    section Phối Hợp (Sync)
    Internal Link & Content Mapping   :2026-05-01, 30d
    UAT & SEO Testing                 :2026-10-15, 15d
```
